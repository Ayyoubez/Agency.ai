...
function Hero() {
  return (
    ...
    >
      ...
      <h1 className="text-4xl sm:text-5xl xl:text-[84px] md:text-6xl font-medium max-w-5xl xl:leading-[95px]">
      ...
      <div className="relative">
        ...
        <img
          src={assets.bgImage1}
          alt=""
          className="absolute -top-40 -righ-40 sm:-top-100 sm:-right-70 -z-1 dark:hidden"
        />
      </div>
    </div>
  );
